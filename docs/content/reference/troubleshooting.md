...
Most of these come down to network reality or how hexpm serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hexpm rate-limits like any public site. hexpm already paces
...
Where a surface is gated, hexpm reads a cookie or token you supply
...
`hexpm`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hexpm actually did
